...
nohup $DARKFLOW_HOME/flow --train --annotation $ANNOTATION_HOME --dataset $IMAGE_HOME --model $DARKFLOW_HOME/cfg/tiny-ai-weights-lc-mlb.cfg --load 344502 --trainer adam --gpu 0.9 --lr 1e-5 --keep 15 --backup $DARKFLOW_HOME/ckpt/mlb_branch/ --batch 8 --save 2900 --epoch 3000 > ../logs/train.log &
